...
import com.wildstartech.wfa.NameTooLongException;

public class CompanyNameTooLongException extends NameTooLongException {
    /**
     * Unique class version identifier used in object serialization.
     */
    private static final long serialVersionUID = 814090577014998411L;
    /**
    ...
    private static String RESOURCE_BUNDLE_KEY =
            CompanyResources.class.getName();
    public CompanyNameTooLongException(String name, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("CompanyNameTooLongException", new Object[]{
            name,
            length
        });
    }
