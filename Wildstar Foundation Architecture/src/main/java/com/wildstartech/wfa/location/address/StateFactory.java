...
import com.wildstartech.wfa.location.address.us.LocalStateFactoryImpl;
...
public abstract class StateFactory {
   ...
   * @return
   */
  public abstract State getState(String key);
   ...
   * @return
   */
  public abstract List<String> getContinentalAbbreviations();

  /**
   * Returns a list of all the continental state names.
   * @return
   */
  public abstract List<String> getContinentalStateNames();

  /**
   * Returns a list of territory names.
   */
  public abstract List<String> getMilitaryNames();

  /**
   * Return a list of keys for states by full name.
   */
  public abstract List<String> getStateNames();

  /**
   * Returns a list of territory names.
   */
  public abstract List<String> getTerritoryNames();
