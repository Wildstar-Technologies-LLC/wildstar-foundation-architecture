...
public class UserNameTooLongException extends WFAException {
     ...
     */
    private static final long serialVersionUID = 5919970378488779561L;

    public UserNameTooLongException(String name, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("UserNameTooLongException", new Object[]{
                    name,
                    length
                });
    }
