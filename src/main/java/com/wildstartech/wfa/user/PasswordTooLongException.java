...
public class PasswordTooLongException extends WFAException {
    /**
     * Used in object serialization/de-serialization to validate the object.
     */
    private static final long serialVersionUID = -4160184516128236035L;
    /**
    ...
    private static String RESOURCE_BUNDLE_KEY =
            UserResources.class.getName();
    /**
     * Object Serialization/deseiralization version identifier
     */
    public PasswordTooLongException(int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("PasswordNameTooLongException", new Object[]{
                    length
                });
    }
}