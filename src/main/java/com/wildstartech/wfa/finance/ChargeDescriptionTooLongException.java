...
public class ChargeDescriptionTooLongException extends WFAException {

    /**
     * Unique class version identifier used in serialization/deserialization.
     */
    private static final long serialVersionUID = 7330550306330066444L;
    /**
    ...
    private static String RESOURCE_BUNDLE_KEY =
            ChargeResources.class.getName();

    public ChargeDescriptionTooLongException(String description, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("ChargeDescriptionTooLongException", new Object[]{
                    description,
                    length
                });
    }
