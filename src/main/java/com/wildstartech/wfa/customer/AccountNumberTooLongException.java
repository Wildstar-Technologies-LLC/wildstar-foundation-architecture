...
public class AccountNumberTooLongException extends WFAException {
    /**
     * Unique class version identifier used in object serialization.
     */
    private static final long serialVersionUID = -6879849404671046029L;
    /**
    ...
    private static String RESOURCE_BUNDLE_KEY =
            CustomerResources.class.getName();
    public AccountNumberTooLongException(String id, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("CustomerIdTooLongException", new Object[]{
            id, length
        });
    }
}
