...
public class CustomerOrderIdTooLongException extends WFAException {

    /**
     * Unique class version identifier used in object serialization/deserialization.
     */
    private static final long serialVersionUID = 4352539816795728278L;
    /**
    ...
    public CustomerOrderIdTooLongException(String id, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("CustomerOrderIdTooLongException", new Object[]{
                    id, length
                });
    }
}
