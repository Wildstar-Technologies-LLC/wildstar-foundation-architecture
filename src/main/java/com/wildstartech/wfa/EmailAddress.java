...
public class EmailAddress implements Serializable {
    ...
    * false.
    *
    * Its default value is true to remain RFC 2822 compliant, but you should set
    * it depending on what you need for your application.
    */
    ...
    * (john.smith@somewhere.com - no quotes or angle brackets), then change this
    * constant to false.
    *
    * Its default value is true to remain RFC 2822 compliant, but you should set
    * it depending on what you need for your application.
