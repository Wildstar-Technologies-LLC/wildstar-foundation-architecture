...
/*
 * Portions of this code were derived from code written by Les Hazelwood.
 * 
 ...
 * reference my site at leshazlewood.com. Thanks!
 * 
 * @see http://leshazlewood.com/2006/11/06/emailaddress-java-class/
 * @author Les Hazlewood
 */
public class EmailAddress implements Serializable {
	/** Used in object serialization. */
	private static final long serialVersionUID = -124540069402657068L;

  /**
	 * Indicates domain literals are allowed in an e-mail address.
	 * 
	 * <p>This constant states that domain literals are allowed in the email
     * address, e.g.:</p>
     * <ul>
     * <li>someone@[192.168.1.100]</li>
	 * <li>john.doe@[23:33:A2:22:16:1F]</li>
	 * <li>me@[my computer]</li>
	 * </ul>
	 ...
	 * allow valid domain names (RFC 1035, x.y.z.com, etc), change this constant
	 * to false.</p>
	 * <p>Its default value is true to remain RFC 2822 compliant, but you should
	 * set it depending on what you need for your application.</p>
	 */
	private static final boolean ALLOW_DOMAIN_LITERALS = true;

	/**
	 * <p>This contstant states that quoted identifiers are allowed (using
	 * quotes and angle brackets around the raw address) are allowed, e.g.:</p>
	 * <p><code>"John Smith" &lt;john.smith@somewhere.com&gt;</code></p>
	 * <p>The RFC says this is a valid mailbox. If you don't want to allow this,
	 * because for example, you only want users to enter in a raw address
	 * (<code>john.smith@somewhere.com</code> - no quotes or angle brackets),
	 * then change this constant to false.</p>
	 * <p>Its default value is true to remain RFC 2822 compliant, but you 
	 * should set it depending on what you need for your application.</p>
	 */
	...
	/**
	 * Constructor with initializing text passed as a parameter.
	 * @param text the value to be used as the e-mail address for this class.
	 */
	 ...
	 * 
	 * 
	 * Default is false for convenience's sake - if a bounced message is ever
	 * received for this address, this value should be set to true until
	 * verification can made.
	 * 
	 ...
	 * 
	 * <p>Verification is usually done by sending an email to this address and
	 * waiting for the party to respond or click a specific link in the email.</p>
	 * 
	 * 
	 * 
	 * Default is false.
	 ...
	 * valid according to the RFC 2822 rules.
	 * 
	...
	/**
	 * Returns a <code>String</code> representation of the e-mail address.
	 * @return the e-mail address as a <code>String</code> value. 
	 */
