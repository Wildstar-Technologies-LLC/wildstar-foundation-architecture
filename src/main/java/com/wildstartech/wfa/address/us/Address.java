...
public class Address {
	private static final String _CLASS=Address.class.getName();
	private static final Logger logger=Logger.getLogger(_CLASS);
	private static final CountryFactory countryFactory=
			CountryFactory.getInstance();			
	private static final StateFactory stateFactory=StateFactory.getInstance();
    ...
    /**
     * @param java.lang.String A string representation of the US States.
     */
    ...
    public String getZipCode() {
    	logger.entering(_CLASS,"getZipCode()");
    	logger.exiting(_CLASS,"getZipCode()",this.zipCode);
        return this.zipCode;
    }
    ...
    public void setZipCode(String zipCode) {
    	...
    	this.zipCode=Utils.defaultValue(zipCode);
    ...
    /**
     * Output the street address to a list.
     */
    ...
    public static Address parseAddress(String address) {
        ...
        addr.setZipCode(tmpStr.substring(startPos));
        //***** Country
