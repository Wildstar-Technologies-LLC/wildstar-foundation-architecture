...
public class JournalDescriptionTooLongException extends WFARuntimeException {
    /**
     * Unique version identifier used in object serialization/deserialization.
     */
    private static final long serialVersionUID = -3055681342712642412L;
    /**
    ...
    private static String RESOURCE_BUNDLE_KEY =
            JournalResources.class.getName();
    public JournalDescriptionTooLongException(String description, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("JournalDescriptionTooLongException", new Object[]{
            description,
            length
        });
    }
