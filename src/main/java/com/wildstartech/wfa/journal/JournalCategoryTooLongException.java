...
public class JournalCategoryTooLongException extends WFARuntimeException {
     ...
     */
    private static final long serialVersionUID = 9064489783680393341L;
    /**
    ...
    public JournalCategoryTooLongException(String type, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("JournalTypeTooLongException", new Object[]{
            type,
            length
        });
    }
