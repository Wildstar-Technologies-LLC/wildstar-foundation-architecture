 ...
 */
package com.wildstartech.wfa.role;

import com.wildstartech.wfa.WFAException;

public class RoleNameTooLongException extends WFAException {
    /**
     * Unique class version identifier used in object serialization.
     */
    private static final long serialVersionUID = -5386247625387900225L;
    /**
    ...
    private static String RESOURCE_BUNDLE_KEY =
            RoleResources.class.getName();
    public RoleNameTooLongException(String name, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("RoleNameTooLongException", new Object[]{
            name,
            length
        });
    }
