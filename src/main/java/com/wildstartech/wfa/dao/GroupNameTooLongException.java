...
public class GroupNameTooLongException extends WFAException {
	 ...
	 */	
	private static final long serialVersionUID = 6574633537807686581L;
	/**
	...
	private static String RESOURCE_BUNDLE_KEY=
		com.wildstartech.wfa.dao.resources.Group.class.getName();
	public GroupNameTooLongException(String name,int length) {
		super(RESOURCE_BUNDLE_KEY);
		localizeMessage("GroupNameTooLongException",new Object[] {
				name,
				length
				}
			);
