...
public interface AccessorialChargeDAO 
extends WildDAO<AccessorialCharge, PersistentAccessorialCharge> {
  /**
   * Returns a list of accessorial charges associated with the specified quote.
   * 
   * @param quoteId
   * @return
   */
