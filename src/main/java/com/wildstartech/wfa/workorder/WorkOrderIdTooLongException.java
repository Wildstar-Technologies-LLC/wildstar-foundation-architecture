...
public class WorkOrderIdTooLongException extends WFAException {
    /**
     * Unique class version identifier used in object serialization.
     */
    private static final long serialVersionUID = -3027923993772911460L;
    /**
    ...
    public WorkOrderIdTooLongException(String workOrderId, int length) {
        super(RESOURCE_BUNDLE_KEY);
        localizeMessage("WorkOrderIdTooLongException", new Object[]{
                    workOrderId, length
                });
    }
}
