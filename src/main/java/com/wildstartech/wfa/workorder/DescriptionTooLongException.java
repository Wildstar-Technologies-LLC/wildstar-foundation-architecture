...
public class DescriptionTooLongException extends WFAException {
    /**
     * Unique version identifier used in object serialization/deserialization.
     */
    private static final long serialVersionUID = -1600118353622166839L;
    /**
    ...
    private static String RESOURCE_BUNDLE_KEY =
        com.wildstartech.wfa.workorder.resources.WorkOrderLineItem.class.getName();
